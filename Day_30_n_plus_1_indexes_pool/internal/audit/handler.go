...
// list — branches on ?include=notes. Without it, returns plain entries.
// With it, the ?strategy= param picks between three implementations of
// the same view (see README.md §1).
