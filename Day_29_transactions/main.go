...
//
// New from Day 28:
//   - internal/dbtx (Transactor + tx-on-context plumbing)
//   - internal/audit (append-only audit log)
//   - notes service wraps Create/Update/Patch/Delete in InTx and writes
//     an audit row in the same transaction
//   - GET /audit reads the calling user's log
//
// main.go construction order:
//   config -> logger -> db -> migrate -> Transactor -> repos -> services
...
import (
	...
	"day29/internal/audit"
	"day29/internal/auth"
	"day29/internal/config"
	"day29/internal/dbtx"
	"day29/internal/logging"
	mw "day29/internal/middleware"
	"day29/internal/notes"
