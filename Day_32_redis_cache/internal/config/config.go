...
// RedisConfig — URL is the standard redis://user:pass@host:port/db form.
// NotesTTL is the TTL for cached notes entries; jitter is 0..1.
...
type AuthConfig struct {
	...
	JWTIssuer    string        `env:"JWT_ISSUER" envDefault:"day32-auth"`
