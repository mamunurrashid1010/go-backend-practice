...
type AuthConfig struct {
	...
	JWTIssuer    string        `env:"JWT_ISSUER" envDefault:"day33-auth"`
	RefreshTTL   time.Duration `env:"REFRESH_TTL" envDefault:"720h"`
}

// RateLimitConfig — Backend selects between in-process and Redis.
// The two backends use different parameters (token bucket vs sliding
// window). See README §3.
