// Package respond writes consistent JSON responses.
//
// Day 15 additions: the error envelope grows an optional "details" array,
// and ValidationFailed emits a 422 with field-level details.
package respond
...
// ValidationFailed emits a 422 with a details array. `details` is whatever
// validation produced (e.g. []validate.FieldError) — kept as `any` so this
// package doesn't depend on the validate package.
