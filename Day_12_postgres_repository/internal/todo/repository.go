...
// Repository — the data-access boundary. UNCHANGED from Day 11.
//
// Today's PostgresRepository (in postgres_repository.go) also implements
// this interface. Either implementation is interchangeable — that's the
// whole point of today's work.
...
// InMemoryRepository — kept around so tests / dev have a no-DB option.
// UNCHANGED from Day 11.
