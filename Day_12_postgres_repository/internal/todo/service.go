...
// Service — UNCHANGED from Day 11.
//
// It still depends on Repository (the interface) — not on InMemory or
// Postgres. The whole purpose of the layering is that this file is
// identical regardless of which storage is wired in.
type Service struct {
	repo Repository
}
