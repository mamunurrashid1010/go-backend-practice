...
// Router — every route here assumes RequireAuth ran upstream (it's mounted
// inside the protected group in main.go). userID comes from the context.
...
// userIDFromCtx — defense-in-depth helper. RequireAuth should have already
// put it there; if it didn't, that's a routing bug worth a 401.
