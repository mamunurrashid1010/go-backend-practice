...
// TokenVerifier checks the signature, algorithm, issuer, and expiry of an
// access token, and returns the typed claims on success.
...
// Verify parses tokenStr and returns the claims if all checks pass:
//   - signature valid under our secret
//   - alg is HS256 (defends against alg=none + alg-confusion attacks)
//   - iss matches our issuer
