// Day 16 — To-Do API with typed domain errors.
//
// Same wiring as Day 15. The error story is richer (ConflictError, driver
// translation) but it all lives inside the todo package; main.go is the
// same shape.
//
// Run:
//   go mod init day16
...
import (
	...
	"day16/internal/config"
	mw "day16/internal/middleware"
