...
// Handler is the HTTP transport layer. It knows about:
//   - chi routing
//   - JSON encoding/decoding
//   - status codes and the respond.* helpers
//
// It does NOT know about:
//   - business rules (those live in Service)
//   - storage (Repository sits two layers down)
//
// The only way the handler influences the domain is by calling Service
// methods and mapping the errors it gets back.
type Handler struct {
	Svc *Service
}
...
//
// This is the ONLY place in the codebase that translates business errors
// into HTTP status codes. Add a new error type? Add one case here.
