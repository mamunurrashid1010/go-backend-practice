...
// Repository is the data-access boundary. Anything that can persist and
// retrieve todos satisfies it: today's InMemoryRepository, Day 12's
// PostgresRepository, or a mock in Day 22's unit tests.
//
// Every method takes a context — for cancellation and timeouts. The
// in-memory version ignores it (operations are instantaneous); the
// Postgres version forwards it to QueryContext et al.
...
// ------------------------------------------------------------
// InMemoryRepository — Day 7's store, behind the Repository interface.
// ------------------------------------------------------------
